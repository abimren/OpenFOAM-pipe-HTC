...
# *********************************************************
file='../logs/Ux_0'
Ux_0=np.loadtxt(file)
file='../logs/UxFinalRes_0'
UxFinalRes_0=np.loadtxt(file)
file='../logs/Uy_0'
Uy_0=np.loadtxt(file)
file='../logs/UyFinalRes_0'
UyFinalRes_0=np.loadtxt(file)
file='../logs/Uz_0'
Uz_0=np.loadtxt(file)
file='../logs/UzFinalRes_0'
UzFinalRes_0=np.loadtxt(file)
file='../logs/p_0'
p_0=np.loadtxt(file)
file='../logs/pFinalRes_0'
pFinalRes_0=np.loadtxt(file)
